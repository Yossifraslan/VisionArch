...
TASK: Convert the input 2D floor plan into a **photorealistic, top-down 3D architecural render**.
...
2) **GEOMETRY MUST WATCH**: Walls, rooms, doors, and windows must follow the exact lines and positions in the plan. Do not shift or resize.
3) **TOP-DOWN ONLY**: Orthographic top-down view. No perspective tilt.
4) **CLEAN, REALISTIC OUTPUT**: Crisp edges, balance lighting, and realistic materials. No sketch/hand-drawn look.
5) **NO EXTRA CONTENT**: Do not add rooms, furniture, or objects that are not cleary indicated by the plan.
...
- Dining table icon -> tables with chairs.
...
STYLE & LIGHTING:
- Lighting: bright, neutral daylight. High clarity and balance contrast.
